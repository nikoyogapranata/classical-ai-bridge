...
<style>
    ...
    .hero-title {
        font-size: 3rem;
        font-weight: 800;
        background: linear-gradient(135deg, #7c6af7, #f7516a);
    ...
    div[data-testid="stPills"] > div:first-child {
        display: flex !important;
        justify-content: center !important;
    ...
    .metric-value { font-size: 2.2rem; font-weight: 700; color: #7c6af7; }
    .metric-label {
    ...
    .result-card-neural { border-left: 3px solid #f7516a; }
    .result-score { font-size: 0.85rem; color: #888; margin-top: 0.3rem; }
    .result-text { font-size: 0.95rem; color: #ccc; margin-top: 0.3rem; line-height: 1.5; }
    .result-category {
        font-size: 0.8rem; color: #7c6af7; font-weight: 600;
    ...
    .pred-bar-container {
        background: #1a1a24; border-radius: 10px;
...
if page == "🔍 Semantic Search":
    ...
    if query and query.strip():
        ...
        fig.update_layout(
            ...
            xaxis=dict(gridcolor='#2a2a3a', title='Result Rank'),
            yaxis=dict(gridcolor='#2a2a3a', title='Cosine Similarity Score', range=[0, 1]),
        ...
        <div class="metric-card">
            ...
            <div style="font-size:0.95rem; color:#e0e0e0; line-height:1.6">
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if predict_btn and user_input.strip():
        ...
        <div class="metric-card" style="border-left: 3px solid #7c6af7; margin-bottom:1.5rem">
            ...
            <div style="font-size:2.2rem; font-weight:800; color:#e8e8e8">
                {pred_emoji}
            </div>
            <div style="font-size:0.85rem; color:#888; margin-top:0.3rem">
                {pred_cat}
        ...
        for idx in sorted_indices:
            ...
            color    = '#7c6af7' if is_top else '#3a3a4a'
            txtcolor = '#e8e8e8' if is_top else '#aaa'
            ...
            <div class="pred-bar-container" 
                ...
                <div style="background:#2a2a3a; border-radius:999px; 
        ...
        if len(nonzero_idx) > 0:
            ...
            st.markdown("""
            <div style="color:#888; font-size:0.9rem; padding:1rem">
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    for year, name, desc, color in timeline:
        ...
        <div style="display:flex; gap:1.2rem; margin-bottom:0.8rem; align-items:flex-start">
            <div style="min-width:52px; text-align:right">
                <span style="font-size:0.75rem; color:#aaa; font-weight:600">{year}</span>
            </div>
            ...
            <div class="metric-card" style="flex:1; margin-bottom:0; 
                ...
                <div style="font-size:0.95rem; font-weight:700; 
                            color:#e8e8e8; margin-bottom:0.2rem">{name}</div>
    ...
    if algo == "TF-IDF":
        ...
        with col1:
            ...
            <div class="metric-card">
                ...
                <div style="color:#e0e0e0; font-size:0.9rem; margin-top:0.5rem; line-height:1.7">
        ...
        if demo_text.strip():
            ...
            if len(nonzero) > 0:
                ...
                fig.update_layout(
                    ...
                    yaxis=dict(gridcolor='#2a2a3a', title='TF-IDF Score'),
                    margin=dict(l=20, r=20, t=10, b=20),
                    height=280
                )
                st.plotly_chart(fig, use_container_width=True)
                ...
                st.markdown("""
                <div style="color:#888; padding:1rem; font-size:0.9rem">
    ...
    <div class="metric-card" style="border-left: 3px solid #7c6af7; 
                                     background: linear-gradient(135deg, #1e1a3a, #1a1024)">
        <div style="font-size:0.8rem; color:#888; margin-bottom:0.8rem; 
                    text-transform:uppercase; letter-spacing:0.08em">
            Core Argument
        </div>
        <div style="font-size:1.1rem; color:#e0e0e0; line-height:1.8; font-weight:500">
